...
<div id="newQuizBlock1" class="panel panel-default">
	<form onsubmit="return checkTitle()" action="functions/saveQuiz.php" method="POST" >
	...
	<div id="newQuizblock2" class="panel panel-info col-md-12 col-xs-12">
		<div class="panel-heading col-md-12 col-xs-12"><input id="newQuizHeader2"  placeholder="Enter Test title here" class="col-md-7 col-xs-12" name="quiz-title" required>
			<div class="col-md-2  label label-info col-md-offset-1 col-xs-6"><p><span class="badge" id="totalPoints">120</span>Point(s)</p></div>
			<div class="col-md-2  label label-warning col-xs-6 "><p><span class="badge" id="totalQuestions">12</span>question(s)</p></div>
		</div>
	</div>
		...
		<div class="questions" >
	  		<div id="tabs-1" class="panel panel-warning activeQuestion question row">
				<div class="panel-heading col-md-12 col-xs-12"><input placeholder="Enter Question here" class="col-md-10 newQuizHeader3 col-xs-12" name="q1-desc" required>
					<p class=" col-md-2 col-xs-12 text-center"><span class="badge"><input type="number" class="points col-md-10" value="1" name="q-points-1" onkeyup="updateTotalPoints()"></span>Point</p>				
				</div>
				<input type="hidden" class="choiceCount" name="totalChoice1" value="2">
				<div class="form-group">
					    <p class="help-block">Please ensure to place a blank (___)  equivalent to 3 underscores ( _ ) within the question description.</p>
					  </div>
	  		</div>
		</div>
...
<script src="js/createQuiz2.js"></script>
